  ...
  return (
    <section className="relative overflow-hidden  bg-gradient-to-r from-black via-[#111111] to-black ">
      <section className="relative h-screen  overflow-hidden">
        ...
        "
            >
              Discover thoughtfully crafted kidswear where timeless style meets
              everyday comfort. From refined essentials and playful casuals to
              contemporary streetwear and elevated outerwear, every piece is
              designed to bring comfort, confidence, and effortless style to
