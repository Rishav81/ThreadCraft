...
const SearchPage = () => {
  ...
  return (
    <>
      <Seo
        title={
          searchQuery ? `${searchQuery} | ThreadCraft` : "Search | ThreadCraft"
        }
        description={
          searchQuery
            ? `Explore search results for ${searchQuery} at ThreadCraft. Discover men's, women's and kids' fashion.`
            : "Search ThreadCraft for men's, women's and kids' clothing and fashion."
        }
      />
      ...
      <motion.main
        ...
        initial="hidden"
        animate="visible"
        className="min-h-screen px-4 pb-20 pt-20 lg:pt-24 sm:px-6 lg:px-8 "
      >
          ...
          {searchQuery && searchResults.length === 0 && (
            ...
            >
              <div className="max-w-sm">
                ...
                <p className="mt-2 text-xs leading-relaxed text-gray-500 sm:text-sm">
                  Try searching with a different keyword, product name, brand,
                  or category.
                </p>
